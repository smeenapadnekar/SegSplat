...
class LERFModelConfig():
    ...
    num_lerf_samples: int = 8
    hashgrid_layers: Tuple[int] = (8, 8)
    hashgrid_resolutions: Tuple[Tuple[int]] = ((24, 96), (64, 256))
    hashgrid_sizes: Tuple[int] = (18, 18)
...
class LERFModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.image_encoder_featdim = 100 # OpenCLIPNetworkConfig().clip_n_dims # TODO: Rocky, check this #meena constant for now
