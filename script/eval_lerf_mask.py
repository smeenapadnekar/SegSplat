...
gt_folder_path = os.path.join('output',dataset_name,'test/ours_10000/gt_seg/')
# You can change pred_folder_path to your output
pred_folder_path = os.path.join('output',dataset_name,'test/ours_10000/test_seg/')
print(gt_folder_path,pred_folder_path)
...
for image_name in os.listdir(gt_folder_path):
    ...
    # print(gt_image_path,pred_image_path)
    ...
    #         pred_mask_path = os.path.join(pred_image_path, cat_file)
            ...
            print("GT:  ",gt_image_path)
            print("Pred:  ",pred_image_path)
