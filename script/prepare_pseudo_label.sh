...
if [ "$scale" = "1" ]; then
    img_path="../dataset/${dataset_name}/images"
else
    img_path="../dataset/${dataset_name}/images_${scale}"
fi
...
cp -r ./example/output_gaussian_dataset/${dataset_name}/Annotations ../dataset/${dataset_name}/object_mask_bin
cd ..
