...
for scene in ['Barn', 'Family']:
    pipeline(scene, base_path = '/media/vplab/6b43b65c-0636-45e8-b1a2-033acce48735/Meena/3DGD/FewShot/joint_gs_seg/dataset/Tanks/', n_views = 8)  # please use absolute path!
