...
for scene in ['book_store',  'bouquet',  'donuts',  'dozer_nerfgun_waldo',  'espresso',  'figurines',  'fruit_aisle',  'hand_hand',  'ramen',  'shoe_rack',  'sunnyside',  'teatime',  'veggie_aisle',  'waldo_kitchen']:# ['bonsai', 'counter', 'garden', 'kitchen', 'room', 'stump']:
    pipeline(scene, base_path = '/media/vplab/6b43b65c-0636-45e8-b1a2-033acce48735/Meena/3DGD/FewShot/JointGS_Seg/dataset/LERF/', n_views = 3)  # please use absolute path!
