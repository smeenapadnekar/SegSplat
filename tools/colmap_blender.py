...
for scene in ['chair','drums','ficus','hotdog','lego','materials','mic','ship']:
    pipeline(scene, base_path = '/media/vplab/6b43b65c-0636-45e8-b1a2-033acce48735/Meena/3DGD/FewShot/FSGS_Seg/dataset/nerf_synthetic/', n_views = 3)  # please use absolute path!
