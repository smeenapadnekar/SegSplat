...
for scene in ['garden']:
    print("**************Started for ", scene)
    pipeline(scene, base_path = '/media/vplab/6b43b65c-0636-45e8-b1a2-033acce48735/Meena/3DGD/FewShot/joint_gs_seg/dataset/mipnerf360/', n_views = 24)  # please use absolute path!
    print("**************Ended for ", scene)
