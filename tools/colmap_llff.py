...
for scene in ['fern', 'flower', 'fortress',  'horns',  'leaves',  'orchids',  'room',  'trex']:# ['bonsai', 'counter', 'garden', 'kitchen', 'room', 'stump']:
    pipeline(scene, base_path = '/media/vplab/6b43b65c-0636-45e8-b1a2-033acce48735/Meena/3DGD/FewShot/FSGS_Seg/dataset/nerf_llff_data/', n_views = 3)  # please use absolute path!
