...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, alpha, radii, pixels, bg_pixels, geomBuffer, binningBuffer, imgBuffer, imgrad_pixels, bg_imgrad_pixels = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, alpha, pixels, bg_pixels, imgrad_pixels, bg_imgrad_pixels

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_alpha, pixels_grad, imgrad_pixels_grad, bg_pixels_grad, bg_imgrad_pixels_grad):
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None,importance_map = None, bg_map = None):
